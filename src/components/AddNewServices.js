  ...
  return (
    <div class={`${props.showAddServiceBox === true ? "flex" : "hidden" } fixed w-full h-full bg-slate-500/60 items-center justify-center z-10`}>
      <div class="fixed flex flex-col gap-6 items-center justify-center bg-white p-24 rounded-xl z-10 drop-shadow-md">
          ...
          <input type="text" ref={serviceNameRef}  placeholder='nazwa' class='border rounded-md p-2 mr-2' />
          <input type="number" ref={servicePriceRef}  placeholder='cena' class='border rounded-md p-2 mr-2'/>
          <input type="number" ref={serviceTimeRef}  placeholder='czas' class='border rounded-md p-2 mr-2'/>
